...
print("Percentage of wins when switching the door is : ",
      win_with_switching / times)
print()
print("Percentage of wins without switching the door is : ",
      win_with_not_switching / times)
